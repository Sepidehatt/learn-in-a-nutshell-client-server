...
//edit comment
router.put('/comments/:commentId/edit', (req, res, next) => {
  const { commentId } = req.params;

  Comment.findById(commentId)
    .then(commentDetails => {
      if (commentDetails.commentOwner == req.payload._id) {
        return Comment.findByIdAndUpdate(commentId, req.body, { new: true })
